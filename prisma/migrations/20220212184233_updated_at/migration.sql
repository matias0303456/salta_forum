...
-- AlterTable
ALTER TABLE `comment` ALTER COLUMN `last_update` DROP DEFAULT;

-- AlterTable
ALTER TABLE `post` ALTER COLUMN `last_update` DROP DEFAULT;

-- AlterTable
ALTER TABLE `response` ALTER COLUMN `last_update` DROP DEFAULT;

-- AlterTable
ALTER TABLE `user` ALTER COLUMN `last_update` DROP DEFAULT;
